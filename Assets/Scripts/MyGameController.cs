...
[System.Serializable]
public class MyEnemyWaves
{
    [Tooltip("time for wave generation from the moment the game started")]
    public float myTimeToStart;

    [Tooltip("Enemy wave's prefab")]
    public GameObject myEnemyWave;
}
...
public class MyGameController : MonoBehaviour
{
        ...
        public MyEnemyWaves[] enemyWaves;
       ...
       // List<GameObject> planetsList = new List<GameObject>();
        ...
        public void Start()
        {
            ...
            {
                StartCoroutine(CreateEnemyWave(enemyWaves[i].myTimeToStart, enemyWaves[i].myEnemyWave));
            }
